    ...
    return (
        <>
            ...
            '>
                ...
                className='w-full flex flex-col relative cursor-pointer z-[1] rounded-lg overflow-hidden aspect-square'>
                    <Image src={data.imageUrl} fill={true} alt='Item Image' priority={true}
                    sizes="(max-width: 640px) 20vw, (max-width: 1200px) 30vw, 20vw"
