...
export default function HeroSection () {
    ...
    return (
        ...
        className="flex flex-col z-[39] items-center justify-center  relative h-[calc(100vh-80px)] top-0 w-[calc(100vw-(100vw-100%)] box-border pb-[80px]  mx-[-7.5vw]">
            ...
            <div className="w-[40%] aspect-square  max-w-[250px] relative mb-8 md:w-[20%]">
                <Image className="object-scale-down"  src={Logo} fill={true} loading="eager"/>
            </div>
            <Link href='/#Pizza' className="flex justify-between mb-4 items-center w-[50%] max-w-[300px] px-8 py-3 border-0 border-solid border-primay-light relative imageDropShadow transform-gpu">
                <h3 className="w-full text-center text-2xl">Meniu</h3>
                <Image src={BrushStrokeImg} className='filterToComplimentary -z-10' fill={true}/>
            </Link>
            <Link href='/#Pizza' className="flex justify-between items-center w-[50%] max-w-[300px] px-8 py-3 border-0 border-solid border-primay-light relative imageDropShadow transform-gpu">
